...
<div id="messenger">
 ...
 <!-- ---------------------------------채팅방 다이브--------------------------- -->
<div id="ERCwindow" class="chat_board" >
	<div class='row'>
	<div class="col-sm-12"> 
		<form>
			...
			<div class="form-group">
				<h4>대화내용</h4>
				<div id="chatArea">
					<div id="chatMessage"style="height: 600px; border: 1px gray solid; overflow: auto">
			...
			<input class="btn btn-success" type="button" id="sendBtn" value="닫기">
		</form>
	</div>
	</div>
</div> 
...
$(function (){
		...
		wsocket.addEventListener('message',function(e){
			...
			var receiveData=e.data.split("/")[1];
			var receive_erc=e.data.split("/")[0];
		...
		function sendMessage(){
			//서버로 메시지 전송
			wsocket.send(cur_erc_no+'/msg:'+nickname+':'+$('#message').val());//msg:Superman:안녕
			//DIV(대화영역)에 메시지 출력
