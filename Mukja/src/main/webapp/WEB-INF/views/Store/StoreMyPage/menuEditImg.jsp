...
$(document).on("click",".addMenu",function(){
    ...
    var innerHtml = "<div class='row'>"
      ...
      + "<input type='hidden' id='insmenu_tend"+menuFlag+"' class='tendMust' name='insmenu_tend"+menuFlag+"'/>"
       ...
       + "<div class='col-xs-12'>"
       + "<div class='col-xs-1'>"
       + "<img id='F_FS"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/pesco_o.png'/>' alt='F' class='img-circle img_size flag'>"
       + "<div class='lb_size'>생선</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_EG"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/ovo_o.png'/>' alt='E' class='img-circle img_size flag'>"
       + "<div class='lb_size'>달걀</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_MK"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/dairy_o.png'/>' alt='M' class='img-circle img_size flag'>"
       + "<div class='lb_size'>우유</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_BD"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/chicken_o.png'/>' alt='B' class='img-circle img_size flag'>"
       + "<div class='lb_size'>가금류</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_PK"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/pig_o.png'/>' alt='P' class='img-circle img_size flag'>"
       + "<div class='lb_size'>돼지</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_CW"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/cow_o.png'/>' alt='C' class='img-circle img_size flag'>"
       + "<div class='lb_size'>소</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_PE"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/nuts_o.png'/>' alt='PE' class='img-circle img_size flag'>"
       + "<div class='lb_size'>땅콩</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_SF"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/shrimp_o.png'/>' alt='SF' class='img-circle img_size flag'>"
       + "<div class='lb_size'>갑각류</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_DP"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/dairy_o.png'/>' alt='DP' class='img-circle img_size flag'>"
       + "<div class='lb_size'>유제품</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_SB"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/s_o.png'/>' alt='SB' class='img-circle img_size flag'>"
       + "<div class='lb_size'>대두</div></div>"
       + "<div class='col-xs-1'>"
       + "<img id='F_FL"+menuFlag+"' src='<c:url value='/resources/tend_IMG/sutend/gluten_o.png'/>' alt='FL' class='img-circle img_size flag'>"
