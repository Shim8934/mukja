...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href='<c:url value="/"/>'>Kusina</a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="oi oi-menu"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item"><a href="Restaurants.jsp" class="nav-link">Restaurants</a></li>
	          <li class="nav-item active"><a href="MyPage.jsp" class="nav-link">hohoMyPage</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
			...
			<div class="row justify-content-center pb-2">
				<div class="col-md-7 text-center heading-section ftco-animate">
					<div class="menus d-flex ftco-animate">
						<div class="menu-img img" style="background-image: url(<c:url value='/resources/bootstrap/images/breakfast-1.jpg'/>);"></div>
						<div class="menu-img img" style="background-image: url(<c:url value='/resources/bootstrap/images/breakfast-2.jpg'/>);"></div>
						<div class="menu-img img" style="background-image: url(<c:url value='/resources/bootstrap/images/breakfast-3.jpg'/>);"></div>
						
					</div>
					<p>
						<a href="#" class="btn btn-primary px-4 py-3">맞춤설정</a>
					</p>
				</div>
			</div>
		</div>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="thumb d-sm-flex">
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-1.jpg'/>);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-2.jpg'/>);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-3.jpg'/>);">
	            	</a>
	            </div>
	            <div class="thumb d-flex">
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-4.jpg'/>);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-5.jpg'/>);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<c:url value='/resources/bootstrap/images/insta-6.jpg'/>);">
	            	</a>
	            </div>
            </div>
          </div>
  ...
  Copyrightright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
  ...
  <script src="<c:url value='/resources/bootstrap/js/google-map.js'/>"></script>
