				...
				<section class="ftco-section testimony-section ">
					...
					<!-- REVIEW TITLE -->
						<div class="row justify-content-center mb-5 pb-2">
							...
							<div>
								<a class="menuplus" href="<c:url value='/ReviewList.bbs'/>"> +후기 더 보기</a>
							</div>
						</div>
							...
							<li class="comment">
								...
								<div class="comment-body">
									...
									<p>리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review
										...
										review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review
										리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰
										review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review
										리뷰 review 리뷰 review 리뷰 review 리뷰 review 리뷰 review</p>
									<div class="menu-img img"
						...
						<div class="comment-form-wrap pt-5">
							...
							<form action="#" class="p-4 p-md-5">
								<div class="form-group">
									<label for="email">ID / Email</label> <input type="email" class="form-control" id="email">
								</div>
								<div class="form-group">
